...
class ActorCritic(nn.Module):
    def __init__(self, num_inputs, num_outputs, hidden_size, act_crit, std=0.0):
        super(ActorCritic, self).__init__()
        assert (act_crit == "critic" or act_crit == "actor")
        self.act_crit = act_crit
        if act_crit == "critic":
...
class ActorCriticPCoady(ActorCritic):
    def __init__(self, num_inputs, num_outputs, act_crit, std=-.5):
